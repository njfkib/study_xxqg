...
import (
	"flag"
	"fmt"
	"github.com/LingFeng0918/study_xxqg/utils/stop"
	"io"
	"math/rand"
	"net/http"
	"os"
...
func init() {
	...
	if !utils.CheckQuestionDB() {
		...
		//log.Errorln("题库文件不存在或已损坏，请手动前往 https://github.com/LingFeng0918/study_xxqg/blob/main/conf/QuestionBank.db 下载并放入程序根目录")
	}
}
